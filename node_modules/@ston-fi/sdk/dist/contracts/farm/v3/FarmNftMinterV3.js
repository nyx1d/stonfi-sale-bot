...
const _FarmNftMinterV3 = class _FarmNftMinterV32 extends Contract {
  ...
  async createStakeBody(params) {
    return beginCell().storeUint(FARM_OP_CODES.STAKE, 32).storeAddress(
      (params == null ? void 0 : params.ownerAddress) ? toAddress(params.ownerAddress) : void 0
    ).endCell();
  }
  /**
  ...
  async getFarmingMinterData(provider) {
    ...
    return {
      ...
      farmDataAccrued: (() => {
        const dict = result.stack.readCell().asSlice().loadDictDirect(Dictionary.Keys.Uint(8), Dictionary.Values.Cell());
...
_FarmNftMinterV3.version = FARM_VERSION.v3;
