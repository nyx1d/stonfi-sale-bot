...
const FarmNftMinterV1 = require("../v1/FarmNftMinterV1.cjs");
class FarmNftMinterV2 extends FarmNftMinterV1.FarmNftMinterV1 {
  /**
...
FarmNftMinterV2.version = constants.FARM_VERSION.v2;
exports.FarmNftMinterV2 = FarmNftMinterV2;
