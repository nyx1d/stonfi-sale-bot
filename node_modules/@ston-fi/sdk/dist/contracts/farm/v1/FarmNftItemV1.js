...
const _FarmNftItemV1 = class _FarmNftItemV12 extends Contract {
  ...
  async createClaimRewardsBody(params) {
    return beginCell().storeUint(FARM_OP_CODES.CLAIM_REWARDS, 32).storeUint(BigInt((params == null ? void 0 : params.queryId) ?? 0), 64).endCell();
  }
  /**
  ...
  async createUnstakeBody(params) {
    return beginCell().storeUint(FARM_OP_CODES.UNSTAKE, 32).storeUint(BigInt((params == null ? void 0 : params.queryId) ?? 0), 64).endCell();
  }
  /**
...
_FarmNftItemV1.version = FARM_VERSION.v1;
